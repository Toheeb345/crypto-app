...
return (
    <>
<div className=" flex flex-col mt-0 md:mt-8 border border-gray-100 rounded">
...
<div className=" min-h-[60vh] w-full h-full flex justify-center items-center">
<div className=" w-8 h-8 border-4 border-cyan rounded-full border-b-gray-200 animate-spin" role="status" />
<span className=" ml-3">Fetching Coins...</span>
